...
GraphicManager::GraphicManager()
	: instance(nullptr) , gpu(nullptr) , device( nullptr )
{}
...
void GraphicManager::setInstance(vk::Instance * instance)
{
	this->instance = instance;
}
void GraphicManager::setPhysicalDevice(vk::PhysicalDevice * physical_device)
{
	this->gpu = physical_device;
}

vk::Instance * GraphicManager::createInstance2(void)
{
...
vk::Device * GraphicManager::createDevice(void)
{
	...
	std::unique_ptr< vk::Device > unique_device(new vk::Device());
	result = gpu->createDevice(&deviceInfo, nullptr, unique_device.get() );
	device = unique_device.release();
	VERIFY(result == vk::Result::eSuccess);
